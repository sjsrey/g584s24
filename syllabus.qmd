...
evaluated individually on all five exercises. You can view these exercises as
...
### Project 
The last 5 weeks of the  course are organized as a studio in which each student will contribute to a
final project that requires the application of the various open source
technologies, packages, and practices that are introduced. 
...
[geosnap]: https://oturns.github.io/geosnap/
